...
export default function ConfirmModal({ data, onSubmit, onCancel }: IConfirmModal) {
  return <Div customClassNames="z-10 absolute w-full h-full bg-gray-500/70 flex justify-center items-center">
    <Div customClassNames="bg-white w-4/5 lg:w-2/5 lg:h-3/6 p-3 lg:py-2 flex flex-col justify-center items-center rounded-lg">
      ...
      <Div customClassNames="flex flex-col h-64 md:h-96 gap-5 justify-center items-center text-center px-10">
